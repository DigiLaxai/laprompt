...
export const ApiKeySetup: React.FC<ApiKeySetupProps> = ({ onSave }) => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-md mx-auto bg-slate-800 p-8 rounded-xl shadow-lg border border-slate-700 text-center">
        <KeyIcon className="mx-auto h-12 w-12 text-yellow-400 mb-4" />
        <h2 id="api-key-setup-title" className="text-2xl font-bold text-slate-100 mb-2">Welcome to PromptCraft</h2>
